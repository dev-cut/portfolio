    ...
    <div className={styles.container}>
      ...
      <div className={styles.status}>
        <div className={styles.item}>
          ...
          <span
            className={`${styles.value} ${result.connected ? styles.success : styles.error}`}
          >
      ...
      {!result.connected && (
        <div className={styles.instructions}>
          ...
          <ol>
            <li>
              프로젝트 루트에 <code>.env.local</code> 파일을 생성하세요.
            </li>
            <li>
              다음 내용을 추가하세요:
              <pre>
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=your_supabase_anon_key`}
            ...
            <li>
              Supabase 대시보드에서 프로젝트 설정 &gt; API 메뉴로 이동하여 값을
              확인하세요.
            </li>
            <li>
              개발 서버를 재시작하세요 (<code>npm run dev</code>).
            </li>
          </ol>
        </div>
      )}
